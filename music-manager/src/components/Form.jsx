...
const Form = ({handleAddAlbum})=>{
  ...
  const handleSubmit = (e)=>{
    console.log("Uslo u handleSubmit")
    console.log(genre)
    
    setEmptyFieldExists(false)
    if(!title.length || !author.length|| !year.length || !genre.length){
  ...
  return (<div className="album-input-form"  id = "inputForm" >
    ...
    <input className="album-info-input" type="text " placeholder="Year" value ={year} onChange = {e => setYear(e.target.value)} />
